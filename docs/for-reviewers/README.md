...
This folder collects the shortest reviewer-facing path through ALETHEIA.

Recommended order:

1. `quick_start.md` — 5-minute path for first-time reviewers.
2. `../reviewer_start_here.md` — fuller reviewer guide.
